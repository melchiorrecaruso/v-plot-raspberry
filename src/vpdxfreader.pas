...
type
  ...
  private
   ...
   public
    ...
    procedure readfromstrings(const afilename: string; apaths: tvppaths);
  end;
...
see "Formatting Conventions in This Reference."
...
20,
30   DXF: Y and Z values of center point (in OCS)
40   Radius
...
220,
230  DXF: Y and Z values of extrusion direction (optional)
}
...
20,
30   DXF: Y and Z values of center point (in WCS)
11   Endpoint of major axis, relative to the center (in WCS) DXF: X value; APP: 3D point
21,
31   DXF: Y and Z values of endpoint of major axis, relative to the center (in WCS)
210  Extrusion direction (optional; default = 0, 0, 1) DXF: X value; APP: 3D vector
220,
230  DXF: Y and Z values of extrusion direction  (optional)
...
procedure tvdxfreader.readfromstrings(const afilename: string; apaths: tvppaths);
var
  s: tstringlist;
begin
