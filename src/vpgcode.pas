{
  ...
  Copyright (C) 2014-2019 Melchiorre Caruso <melchiorrecaruso@gmail.com>
...
uses
  classes, fpvectorial, vpmath, vppaths, vpsetting;


procedure vec2paths(stream: tstream; paths: tvppaths);
